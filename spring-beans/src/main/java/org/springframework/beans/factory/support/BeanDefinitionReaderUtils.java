...
public abstract class BeanDefinitionReaderUtils {
	...
	public static void registerBeanDefinition(
		...
		// 向BeanDefinitionMap中添加bd，key是beanName, value是bd（如果bean已创建则执行bd覆盖及bean销毁逻辑），
		// registry是我们传进来的AnnotationConfigApplicationContext，因为它实现了BeanDefinitionRegistry，
		// 所以我们进入AnnotationConfigApplicationContext（父类）的registerBeanDefinition方法。
